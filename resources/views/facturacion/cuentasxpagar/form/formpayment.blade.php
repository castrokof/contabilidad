<fieldset>
    ...
    <div class="form-group row">
        <div class="col-lg-3">
            ...
            <input type="text" id="numerofactura_n" name="numerofactura_n" class="form-control UpperCase" >
        </div>
        <div class="col-lg-3">
            <label for="tipofactura_n" class="col-xs-4 control-label">Tipo de factura:</label>
            <input type="text" id="tipofactura_n" name="tipofactura_n" class="form-control">
        </div>
        <div class="col-lg-3">
