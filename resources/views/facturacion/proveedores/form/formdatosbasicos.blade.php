        ...
        <div class="form-group row">
            <div class="col-lg-2">
                <label for="tipodocumento" class="col-xs-4 control-label requerido"><i class="fas fa-id-badge"> Tipo doc</i></label>

                <select name="tipodocumento" id="tipodocumento" class="form-control select2bs4" required>
