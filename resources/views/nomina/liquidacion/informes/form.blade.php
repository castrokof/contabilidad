<div class="form-group row col-lg-12">
    <div class="col-md-3">
        <label for="quincena" class="col-xs-2 control-label">Seleccionar quincena</label>
        <select name="quincena" id="quincena" class="form-control select2bs4" style="width:200px;">
        </select>
    </div>

    <div class="col-md-3" id="usuario_info">
        <label for="usuario" class="col-xs-2 control-label">Usuario</label>
        <select name="usuario" id="usuario" class="form-control select2bs4" style="width:200px;">
        </select>
    </div>
    <div class="col-md-3">
        <label>&nbsp;</label>
